...
/**
 * Simple class to write lines into from a file. Create a LineWriter object,
 * then send it the writeLine() message as many times as desired. When you
 * finish using it you should close the file ??
 */
public class LineWriter implements Closeable, AutoCloseable {
	...
	public LineWriter(String message) {
		...
		// FileDialog dialog = new FileDialog(new Frame(), message,
		// FileDialog.LOAD);
